...
public class NewsActivityFeed1 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        webView.loadUrl("https://en.prothomalo.com/sports");
    ...
    public void backBtn(View view) {
        ...
        onBackPressed();
        startActivity(new Intent(NewsActivityFeed1.this, NewsFeedActivity.class));
        finish();
    }
    ...
    public void Rating(View view) {
        ...
        Intent intent=new Intent(NewsActivityFeed1.this, RatingActivity.class);
